...
l=decodeURIComponent(l).split('"')[1]):l=void 0,d+='<div class="media"><img src="'+l+'" alt="Image from tweet" /></div>');c.push(d);b++}if(null===w){a=c.length;f=0;g=document.getElementById(z);for(h="<a class='social' href='https://twitter.com/earlysBar'><i class='icon-twitter'></i></a><ul>";f<a;)h+="<li>"+c[f]+"</li>",f++;g.innerHTML=h+"</ul>"}else w(c);t=!1;0<r.length&&(twitterFetcher.fetch(r[0]),r.splice(0,1))}}}();

var config1 = {
  "id": '595175697896857600',
  "domId": 'tw-widget1',
  "maxTweets": 1,
  "enableLinks": true
};
